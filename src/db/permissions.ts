...
const DEFAULT_PERMISSIONS: PermissionRow[] = [
  ...
  { role: "OPS", table_name: "iterations", operation: "update", conditions: null },
  { role: "OPS", table_name: "workflow_instances", operation: "select", conditions: null },
  { role: "OPS", table_name: "workflow_instances", operation: "update", conditions: null },
